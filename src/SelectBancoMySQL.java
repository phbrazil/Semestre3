...
public class SelectBancoMySQL {
    ...
    public boolean CPFCadastradoSelect(long CPF) {
        ...
        try {
            ...
            java.sql.Statement st = conexao.createStatement();
            select = "select count(*) cpf from clientes where cpf = " + BigInteger.valueOf(CPF) + "";
            ResultSet result = st.executeQuery(select);
...
public class SelectBancoMySQL {
    ...
    public void SelectCPFCliente(long CPF) {
