...
public class InsertBancoMySQL {
    ...
    public void InsertNovoCliente(String nome, String logradouro, String RG, String CPF, String bairro, String cidade,
            String estado, String UF, String telefone, String celular, String email, String sexo, String estadocivil, String nascimento) {
        ...
        if (nome.equals("") || nome.equals(" ")) {
            ...
            try {
                ...
                java.sql.Statement st = conexao.createStatement();
                st.executeUpdate("INSERT INTO Clientes (Nome,Logradouro,RG,CPF,Bairro,Cidade,Estado,UF,Telefone,Celular,Email,Sexo,EstadoCivil,Nascimento) \n"
                        + "VALUES ('" + nome + "','" + logradouro + "','" + RG + "','" + CPF + "','" + bairro + "','" + cidade + "','" + estado + "','" + UF + "','" + telefone + "','"
    ...
    public void InsertNovoProduto(String nomeproduto, double valor, String faixaetaria, String fabricante, String prazogarantia, int quantidade) {
        ...
        if (nomeproduto.equals("") || nomeproduto.equals(" ")) {
            ...
            try {
                ...
                java.sql.Statement st = conexao.createStatement();
                st.executeUpdate("INSERT INTO produtos (nomeproduto,valor,faixaetaria,fabricante,prazogarantia, quantidade)"
                        + " VALUES ('" + nomeproduto + "'," + valor + ",'" + faixaetaria + "','" + fabricante + "','" + prazogarantia + "'," + quantidade + ");");
