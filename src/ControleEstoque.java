...
public class ControleEstoque extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JProdValor = new javax.swing.JTextField();
        ...
        getContentPane().add(JProdValor);
        JProdValor.setBounds(330, 250, 150, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        do {
            try {
                ...
                valor = Double.valueOf(JProdValor.getText());
        ...
        if (JNomeProduto.getText().equals("")) {
            ...
            novoproduto.InsertNovoProduto(nomeproduto, valor, faixaetaria, fabricante, prazogarantia, quantidade);
    ...
    private javax.swing.JTextField JProdValor;
