    ...
    public void InsertNovoCliente(String nome, String logradouro, String RG, String CPF, String numero, String cidade,
        ...
        if (nome.equals("") || nome.equals(" ")) {
            ...
            try {
                ...
                java.sql.Statement st = conexao.createStatement();
                st.executeUpdate("INSERT INTO Clientes (Nome,Logradouro,RG,CPF,Numero,Cidade,Estado,UF,Telefone,Celular,Email,Sexo,EstadoCivil,Nascimento) \n"
                        + "VALUES ('" + nome + "','" + logradouro + "','" + RG + "','" + CPF + "','" + numero + "','" + cidade + "','" + estado + "','" + UF + "','" + telefone + "','"
